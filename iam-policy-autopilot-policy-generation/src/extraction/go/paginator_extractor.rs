...
mod tests {
    ...
    fn create_test_service_index() -> ServiceModelIndex {
        ...
        ec2_operations.insert("DescribeInstances".to_string(), Operation {
        ...
        dynamodb_operations.insert("Scan".to_string(), Operation {
            name: "Scan".to_string(),
            input: None,
        });
        ...
        gamelift_operations.insert("DescribeInstances".to_string(), Operation {
            name: "DescribeInstances".to_string(),
            input: None,
        });
        
        services.insert("gamelift".to_string(), SdkServiceDefinition {
            version: Some("2.0".to_string()),
            metadata: ServiceMetadata {
        ...
        for (service_name, api_version, service_id) in [
            ...
            operations.insert("TagResource".to_string(), Operation {
                name: "TagResource".to_string(),
                input: None,
            });
            
            services.insert(service_name.to_string(), SdkServiceDefinition {
                version: Some("2.0".to_string()),
                metadata: ServiceMetadata {
        ...
        method_lookup.insert("DescribeInstances".to_string(), vec![
            ServiceMethodRef {
        ...
        method_lookup.insert("Scan".to_string(), vec![
            ServiceMethodRef {
